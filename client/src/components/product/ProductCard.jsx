...
import { Heart, Star, ShoppingCart, Zap, Check, Eye } from 'lucide-react';
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className={`p-2.5 rounded-xl border transition-colors ${
                  isLiked ? 'bg-rose-50 border-rose-200 text-rose-600' : 'bg-slate-50 border-slate-200 text-slate-500 hover:text-rose-600'
                }`}
              >
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square w-full rounded-xl overflow-hidden bg-slate-100">
        ...
        <button
          onClick={handleToggleWishlist}
          className={`absolute top-2 right-2 p-2 rounded-xl backdrop-blur-md transition-all z-10 ${
            isLiked 
