...
export const AdminDashboard = ({ onNavigate }) => {
  ...
  const [activeTab, setActiveTab] = useState('overview'); // 'overview' | 'sellers' | 'verifications' | 'disputes' | 'payouts' | 'products' | 'coupons' | 'categories'
  ...
  const loadAdminData = async () => {
    try {
      setIsLoading(true);
      const [metRes, selRes, prodRes, cpnRes, catRes, verRes, dspRes, payRes] = await Promise.all([
        api.getAdminMetrics(),
        api.getAdminSellers(),
